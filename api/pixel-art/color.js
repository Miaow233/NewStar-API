 ...
 * @param RGBColor2
 */
function euclidean1 (RGBColor1, RGBColor2) {
 ...
 * @param RGBColor2
 */
function euclidean2 (RGBColor1, RGBColor2) {
  const [r1, g1, b1] = RGBColor1
  const [r2, g2, b2] = RGBColor2
  const deltaR = r1 - r2
  const deltaG = g1 - g2
 ...
 * @return {number}
 */
function euclidean3 (RGBColor1, RGBColor2) {
  const [r1, g1, b1] = RGBColor1
  const [r2, g2, b2] = RGBColor2
  const rBar = (r1 + r2) / 2
  const deltaR = r1 - r2
 ...
 * @constructor
 */
function CIEDE76 (LabColor1, LabColor2) {
  let d = 0
  for (let i = 0; i < 3; i++) {
 ...
 * @constructor
 */
function CIEDE94 (LabColor1, LabColor2) {
 ...
 * @constructor
 */
function CIEDE2000 (LabColor1, LabColor2) {
  const [L1, a1, b1] = LabColor1
  const [L2, a2, b2] = LabColor2
  const C1 = Math.sqrt(a1 * a1 + b1 * b1)
  const C2 = Math.sqrt(a2 * a2 + b2 * b2)
...
function cmc (LabColor1, LabColor2) {
  const l = 2
  const c = 1
  const [L1, a1, b1] = LabColor1
  const [L2, a2, b2] = LabColor2
